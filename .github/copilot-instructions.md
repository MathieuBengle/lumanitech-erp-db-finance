...
- [lumanitech-erp-api-finance](https://github.com/MathieuBengle/lumanitech-erp-api-finance)
...
OWNING API:
lumanitech-erp-api-finance

API REPOSITORY PATH:
https://github.com/MathieuBengle/lumanitech-erp-api-finance

DOMAIN RESPONSIBILITY:
Accounting, journals, budgets, fiscal periods, and currencies.
...
- accounts.account_code is unique
- transactions.transaction_number is unique
- fiscal_periods.period_code is unique
- budgets.budget_code is unique
- currencies.currency_code is unique
- exchange_rates.rate > 0
- transaction_lines.amount >= 0
- No posting to closed fiscal periods (application enforced)
